...
func (f fakeService) CreateUpdate(name, namespace string) error { return nil }
func (f fakeService) Delete(name, namespace string) error       { return nil }
func (f fakeService) List(namespace string) ([]corev1.Service, error) {
